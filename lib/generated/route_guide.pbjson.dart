...
const Rectangle$json = const {
  '1': 'Rectangle',
  '2': const [
    const {'1': 'lo', '3': 1, '4': 1, '5': 11, '6': '.study_dart.Point', '10': 'lo'},
    const {'1': 'hi', '3': 2, '4': 1, '5': 11, '6': '.study_dart.Point', '10': 'hi'},
  ],
};

/// Descriptor for `Rectangle`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List rectangleDescriptor = $convert.base64Decode('CglSZWN0YW5nbGUSIQoCbG8YASABKAsyES5zdHVkeV9kYXJ0LlBvaW50UgJsbxIhCgJoaRgCIAEoCzIRLnN0dWR5X2RhcnQuUG9pbnRSAmhp');
@$core.Deprecated('Use featureDescriptor instead')
const Feature$json = const {
  '1': 'Feature',
  '2': const [
    const {'1': 'name', '3': 1, '4': 1, '5': 9, '10': 'name'},
    const {'1': 'location', '3': 2, '4': 1, '5': 11, '6': '.study_dart.Point', '10': 'location'},
  ],
};

/// Descriptor for `Feature`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List featureDescriptor = $convert.base64Decode('CgdGZWF0dXJlEhIKBG5hbWUYASABKAlSBG5hbWUSLQoIbG9jYXRpb24YAiABKAsyES5zdHVkeV9kYXJ0LlBvaW50Ughsb2NhdGlvbg==');
@$core.Deprecated('Use routeNoteDescriptor instead')
const RouteNote$json = const {
  '1': 'RouteNote',
  '2': const [
    const {'1': 'location', '3': 1, '4': 1, '5': 11, '6': '.study_dart.Point', '10': 'location'},
    const {'1': 'message', '3': 2, '4': 1, '5': 9, '10': 'message'},
  ],
};

/// Descriptor for `RouteNote`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List routeNoteDescriptor = $convert.base64Decode('CglSb3V0ZU5vdGUSLQoIbG9jYXRpb24YASABKAsyES5zdHVkeV9kYXJ0LlBvaW50Ughsb2NhdGlvbhIYCgdtZXNzYWdlGAIgASgJUgdtZXNzYWdl');
